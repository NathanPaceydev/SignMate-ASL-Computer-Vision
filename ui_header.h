#ifndef SIGNMATEMRVJPJ_H
#define SIGNMATEMRVJPJ_H
...
public:
    ...
    {
        SignMateClass->setWindowTitle(QCoreApplication::translate("SignMateClass", "SignMate - Learn ASL Now", nullptr));
